...
export interface AppUser {
  ...
  /** Granted from Stage Roles -  lets this user log externally-manufactured
   * (job work) quantities against any order and any of the 19 stages, from
   * their own Job Work page. See migration 023. */
